"""
This module is for calculation of user's reading time estimation.
"""
import re
...
class ArticleReadTimeEngine:
    """
    Estimation of user's time to read articles.
    """
    @staticmethod
    def word_count(text):
    ...
    def estimate_reading_time(article, words_per_minute=250,
        ...
        word_count_description = ArticleReadTimeEngine.word_count(article.
                                                                  description)

        total_word_count = word_count_body + word_count_title + \
